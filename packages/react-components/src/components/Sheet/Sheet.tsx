...
/**
 * Sheet overlay component - semi-transparent backdrop
 */
...
/**
 * Sheet header component - container for title and description
 */
const SheetHeader = ({
  className,
  ...props
...
/**
 * Sheet footer component - container for action buttons
 */
const SheetFooter = ({
  className,
  ...props
